    ...
    <>
      ...
      <HeaderWrapper>
        ...
        >
          ...
          >
            <path
              d="M3.04375 8.04563L6.99055 12.3773C7.32879 12.7485 7.32879 13.3504 6.99055 13.7216C6.65231 14.0928 6.10391 14.0928 5.76566 13.7216L0.253682 7.67216C-0.0845606 7.30094 -0.0845606 6.69906 0.253682 6.32784L5.76566 0.278417C6.10391 -0.0928057 6.65231 -0.0928057 6.99055 0.278417C7.32879 0.64964 7.32879 1.25151 6.99055 1.62273L3.04375 5.95437H13.0473C13.5734 5.95437 14 6.42251 14 7C14 7.57749 13.5734 8.04563 13.0473 8.04563H3.04375Z"
              fill="#222222"
            />
          </svg>
        </HeaderButton>
        <strong>글 목록으로</strong>
      </HeaderWrapper>
      <PostDetailWrapper>
        <PostInfo
        ...
        {post.imageUrl !== null && typeof post.imageUrl === 'object' ? (
          ...
          <PostContentImage src={post.imageUrl} />
        ) : null}
        <UserActivity
